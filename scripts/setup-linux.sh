#!/usr/bin/env bash
# power-statement-assistant - Linux Setup Script
...
Setup script for Linux (Ubuntu/Debian) - Installs all dependencies for power-statement-assistant
...
print_header "power-statement-assistant - Linux Setup"
