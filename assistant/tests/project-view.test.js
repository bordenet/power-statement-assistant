...
describe('Project View Module', () => {
  ...
  // Helper function to create complete project data
  function createTestProjectData(overrides = {}) {
    return {
  ...
  describe('renderProjectView', () => {
    test('should render project view with phase tabs', async () => {
      const project = await createProject(createTestProjectData());
    ...
    test('should render overflow menu button for secondary actions', async () => {
      const project = await createProject(createTestProjectData());
