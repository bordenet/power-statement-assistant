        ...
        <div class="mb-6 p-6 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
            <div class="flex items-center justify-between flex-wrap gap-4">
                ...
                <div class="flex gap-3 flex-wrap items-center">
                    ...
                    <a href="https://bordenet.github.io/power-statement-validator/" target="_blank" rel="noopener noreferrer" class="text-blue-600 dark:text-blue-400 hover:underline font-medium text-lg">
                        Validate & Score ↗
                    </a>
                </div>
            </div>
            ...
            <details class="mt-4">
                ...
                <div class="mt-3 p-4 bg-white dark:bg-gray-800 rounded-lg text-sm text-gray-700 dark:text-gray-300">
                    <ol class="list-decimal list-inside space-y-2">
                        ...
                        <li>Use <strong><a href="https://bordenet.github.io/power-statement-validator/" target="_blank" rel="noopener noreferrer" class="text-blue-600 dark:text-blue-400 hover:underline">Power Statement Validator</a></strong> to score and improve your document</li>
                    </ol>
