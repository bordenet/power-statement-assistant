/**
 * Type Definitions for Power Statement Assistant
 * @module types
 *
 ...
 * @property {string} productName - Product/service name
 * @property {string} customerType - Customer type
 * @property {string} problem - Problem being solved
 * @property {string} outcome - Desired outcome
 * @property {string} proofPoints - Proof points/results
 * @property {string} differentiators - Key differentiators
 * @property {string} objections - Common objections
