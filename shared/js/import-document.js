 ...
 * Handles importing existing Power Statements from Word/Google Docs via paste
 */
...
const DOC_TYPE = 'Power Statement';
const DOC_TYPE_SHORT = 'Power Statement';
